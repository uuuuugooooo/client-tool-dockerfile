...
RUN curl -L -O https://s3.amazonaws.com/bosh-cli-artifacts/bosh-cli-5.5.0-linux-amd64 && \
    mv bosh-cli-* /usr/local/bin/bosh && \
    curl -L -O https://github.com/pivotal-cf/om/releases/download/1.0.0/om-linux && \
    mv om-linux /usr/local/bin/om && \
    curl -L -O https://github.com/pivotal-cf/pivnet-cli/releases/download/v0.0.58/pivnet-linux-amd64-0.0.55 && \
